...
function App() {
  ...
  return (
    ...
    <div className='App'>
      ...
      <input type="time" value={statet1} name={'time1'} onChange={(e) => setStatet1(e.target.value)} step="2"/><br/>
      <label>{'Arrival Time: '}</label>
      <input type="time" value={statet2} name={'time2'} onChange={(e) => setStatet2(e.target.value)} step="2"/><br/>
